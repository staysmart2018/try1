...
if (distance < 0) {
    clearInterval(x);
    document.getElementById("countdown_day").innerHTML = "EXPIRED";
}
if (distance < 0) {
    clearInterval(x);
    document.getElementById("countdown_hour").innerHTML = "EXPIRED";
}
if (distance < 0) {
    clearInterval(x);
...
if (distance < 0) {
    clearInterval(x);
    document.getElementById("countdown_seconds").innerHTML = "EXPIRED";
}
}, 1000);